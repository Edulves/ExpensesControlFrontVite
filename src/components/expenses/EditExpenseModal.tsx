    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="bg-surface-container-lowest border border-border-subtle rounded-xl w-full max-w-md mx-4 shadow-xl relative z-10 flex flex-col max-h-[85vh]">
        <div className="flex justify-between items-center px-6 py-4 border-b border-border-subtle flex-shrink-0">
          <h3 className="font-title-md text-xl font-semibold text-on-surface">Edit Expense</h3>
          <button
            onClick={onClose}
        ...
        <form className="flex flex-col gap-3 overflow-y-auto p-6" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-1">
            <label className="font-label-caps text-xs font-semibold text-on-surface-variant">Date</label>
            <input
              type="date"
              value={date}
          ...
          <div className="flex flex-col gap-1">
            <label className="font-label-caps text-xs font-semibold text-on-surface-variant">Category</label>
            <select
              value={categoryId}
          ...
          <div className="flex flex-col gap-1">
            <label className="font-label-caps text-xs font-semibold text-on-surface-variant">Note (Optional)</label>
            <input
              type="text"
