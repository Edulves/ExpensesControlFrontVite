    ...
    return (
        <div className="bg-surface-container-lowest border border-border-subtle rounded-xl flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto max-h-[600px] p-4">
                {items.length === 0 && (
                    <p className="font-body-sm text-sm text-on-surface-variant p-6 text-center">Nenhuma categoria com gastos no período.</p>
                )}
                                ...
                                <div className="flex justify-between items-center mb-3 pl-1">
                                    <div className="flex items-center gap-4 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            <h4 className="font-body-lg text-base text-on-surface font-medium truncate capitalize">{item.label}</h4>
                                            <p className="font-body-sm text-sm text-on-surface-variant">{item.percent}% do gasto do mês</p>
                                        </div>
                                    </div>
                                    <div className="text-right flex-shrink-0 pl-2">
                                        <p className="font-label-numeric text-sm text-on-surface font-semibold">
