...
const linkBaseClasses = "flex items-center gap-3 px-2 py-1 rounded-lg transition-all active:scale-95 duration-200 font-semibold text-xl";
        ...
        <aside className="hidden md:flex flex-col py-6 px-2 bg-surface-container-lowest fixed left-0 top-0 h-full w-[240px] z-40 border-r border-border-subtle">
            ...
            <div className="mb-6 flex items-center gap-2 px-2">
                ...
                <div>
                    ...
                    <p className="text-on-surface-variant opacity-70">Calma Financeira</p>
                </div>
            </div>
